...
export default async function Athelete() {
    ...
    return (
        <div>
            ...
            <p>Total Ride Distance: {formatDistance(athleteStats.all_ride_totals.distance)} Km</p>
            <p>Elevation Gain: {athleteStats.all_ride_totals.elevation_gain} m</p>
            <p>Moving Time: {formatMovingTime(athleteStats.all_ride_totals.moving_time)}</p>

            <p>Run Totals</p>
            <p>Runs: {athleteStats.all_run_totals.count}</p>
            <p>Total Running Distance: {formatDistance(athleteStats.all_run_totals.distance)} Km</p>
            <p>Elevation Gain: {athleteStats.all_run_totals.elevation_gain} m</p>
            <p>Moving Time: {formatMovingTime(athleteStats.all_run_totals.moving_time)}</p>
        </div>
    )
}